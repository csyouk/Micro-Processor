...
HandlerIRQ:
	...
	ldr		r9,=INTOFFSET
	ldr		r9,[r9]
	ldr		r8,=ISR_Vectors @ ISR_Vectors의 요소중 하나인 서비스 루틴 주소가 들어가 있다.
	ldr		r8,[r8, r9,lsl #2]
	str		r8,[sp,#8] @ 비어있는 곳에 Invalid_ISR의 서비스 루틴을 넣는다.
	ldmfd	sp!,{r8-r9,pc} @ 스택에서 값을 꺼내가며, pc에 서비스 루틴값을 넣은 후, 그 곳으로 분기한다.

...
//				Lcd_Draw_Cam_Image(0, 0, (void *)q, Cam_Width, Cam_Height);
				...
				Lcd_Draw_Cam_Image_Sharpen_Filter(0, 0, (void *)q, Cam_Width, Cam_Height);

//				Lcd_Draw_Cam_Image_Outline_Filter(0, 0, (void *)q, Cam_Width, Cam_Height);

//				Lcd_Draw_Cam_Image_Blur_Filter(0, 0, (void *)q, Cam_Width, Cam_Height);

//				Lcd_Draw_Cam_Image_Edge_Detect(0, 0, (void *)q, Cam_Width, Cam_Height);

//				Lcd_Draw_Cam_Image_Emboss_Filter(0, 0, (void *)q, Cam_Width, Cam_Height);
...
//				Lcd_Printf(10,10,GREEN,RED,1,1,"(주)윌텍 교육사업부");
			...
			if(Key_value)
			{
				...
				case 1:
					...
					break;
				case 3:
					if(red_divider != 1)red_divider -= 1;
					break;
				...
				case 2:
					...
					break;
				case 4:
					if(green_divider != 1) green_divider -= 1;
					break;
				...
				case 5:
					...
					break;
				case 6:
					if(blue_divider != 1) blue_divider -= 1;
					break;
				}
				Key_value = 0;
			}

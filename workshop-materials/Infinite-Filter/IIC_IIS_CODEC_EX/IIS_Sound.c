...
void Sound_Control_Headphone_Volume(int vol)
{
	...
	if(vol == 0) 
	{
		WM8973_IIC_Write(0x02,0x100);	// LOUT1(HP) Volume => max (0x7f~0x60, 0x00: mute)
		WM8973_IIC_Write(0x03,0x100);	// ROUT1(HP) Volume => max (0x7f~0x60, 0x00: mute)	
